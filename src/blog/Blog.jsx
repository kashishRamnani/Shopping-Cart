                    ...
                    <div className='post-inner'>
                      <div className='post-thumb'>
                        <Link to={`/blog/${blog.id}`}>
                          <img src={blog.imgUrl} alt={blog.title || "Blog post thumbnail"} />
                        </Link>
                      </div>
                      ...
                      <div className='post-footer'>
                             <div className='pf-left'>
                              <Link o={`/blog/${blog.id}`} className='lab-btn-text'>{blog.btnText} <i className='icofont-external-link'></i></Link>
                             </div>
