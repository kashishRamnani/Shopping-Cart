...
const title = (
    <h2 className='title'>Join On Day Long Free Workshop for <b>Adavance <span>Mastering</span>on sales</b></h2>
)
        ...
        <div className='row g-4 row-cols-lg-2 row-cols-1 align-item-center'>
            ...
            <div className='col'>
                ...
                <form className='register-form'>
                    ...
                    <input type="emial" name='email' placeholder='Email' className='reg-input' />
